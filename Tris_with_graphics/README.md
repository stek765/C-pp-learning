...
1) Install SFML (Simple and Fast Multimedia Library), which is a popular multimedia library used for developing graphical applications
2) compile including the libreries and the version of c++ to use, in my case:

    g++ main.cpp Game.cpp -o tris 
